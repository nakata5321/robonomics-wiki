...
<section class="robo-wiki-feedback">
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Get+Notified+When+Door+Opens"> Create an issue</a>
        </div>
			</div>
